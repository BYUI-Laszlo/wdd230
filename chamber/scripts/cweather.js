...
const url = "https://api.openweathermap.org/data/2.5/weather?lat=47.50&lon=19.04&units=metric&appid=a780f5dc068dd2a16ce82f109e3b01b4";
...
function calculateWindChillMetric(T, V) {
...
function displayWindchill(data) {
    ...
    windchill = `${Math.round(calculateWindChillMetric(temperature, windSpeed) * 100) / 100}°C`;
    } else {
    windchill = "N/A";
    }
